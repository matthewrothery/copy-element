...
export default function FeaturesPage(): React.ReactElement {
  return (
    <>
      ...
      <main>
        <PageHero
          title="Everything you need to capture, copy, and build."
          subtitle="Every feature is built around one thing: getting UI from anywhere into your codebase, fast."
        />
        ...
        <Section id="ai">
          <FeatureSection
            ...
            subtitle={
              <>
                <strong>MCP server + AI-ready prompts.</strong> Element Armory pipes captured UI directly into Cursor, Claude, and any MCP-compatible editor.
              </>
            }
            tabs={[
              {
        ...
        <Section id="library">
          <FeatureGrid
            ...
            subtitle={
              <>
                <strong>Save once, reuse everywhere.</strong> Build a personal library of components worth keeping — synced across all your machines.
              </>
            }
            cards={[
              {
