...
readTime: "7 min read"
coverImage: "/topic-images/ai-ui-workflows/ai-prompting-for-ui/best-prompts-for-ui-generation.png"
faq:
...
2. [Capture the HTML and CSS](/topics/copy-ui/copy-css/how-to-copy-css-from-any-website) using Element Armory or DevTools
...
This pattern is especially powerful when combined with [Cursor's ability to use captured UI directly](/topics/ai-ui-workflows/cursor-workflows/use-ui-with-cursor-ai).
...
[Cursor's AI coding assistant](/topics/ai-ui-workflows/cursor-workflows/use-ui-with-cursor-ai) works best when you combine captured UI with generation prompts.
...
![Five-step workflow from capturing UI to deploying production code](/topic-images/ai-ui-workflows/ai-prompting-for-ui/best-prompts-for-ui-generation-diagram-prompt-to-production.svg)

*The complete cycle from prompt to deployed component.*

**Step 1: Capture or Reference**

Find a UI you like. [Capture it with Element Armory](/topics/copy-ui/copy-css/how-to-copy-css-from-any-website) or take a screenshot.
...
Start with [Pattern 1 (Component-First)](/topics/ai-ui-workflows/ai-prompting-for-ui/prompt-for-react-components) for simple components, then graduate to Pattern 3 (Real UI Reference) as you get faster. You'll cut your UI development time in half within a week.
