...
### Fixed
- Capture no longer routes through CDP for elements that don't require theme or viewport emulation, restoring fast in-page extraction
- MCP copy command now reliably delivers output to the connected client

### Changed
- Footer updated with current links and layout
...
- Export as clean HTML or React JSX with minimal, portable styles
- Snippet library for saving and reusing captured elements
- Monthly ($19/mo) and yearly ($9/mo billed annually) subscription plans
