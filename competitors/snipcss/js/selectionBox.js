...
var SelectionBox = function(edgeSize, edgeColor, edgeContainer) {
    ...
    var createEdge = function() {
        //adding this CSS does not work?!?  So just have premade classes
        var css = {
        ...
        if(edgeColor == '#990000'){
            return $('<div>').addClass('edge_builder');
        }else if(edgeColor == '#1666de'){
            return $('<div>').addClass('edge_builder2');            
        }
        else if(edgeColor == '#9b3af2'){
            return $('<div>').addClass('edge_builder3');            
        }        
        else if(edgeColor == '#5602a1'){
            return $('<div>').addClass('edge_builder4');            
        }
        else if(edgeColor == '#76bfff'){
            return $('<div>').addClass('edge_builder5');            
         }
        else if(edgeColor == '#355de5'){
            return $('<div>').addClass('edge_builder6');            
        }     
        else if(edgeColor === '#0061ff') {
            return $('<div>').addClass('edge_builder7');  
        }
        else if(edgeColor === '6111a9') {
            return $('<div>').addClass('edge_builder8');  
        }        
        else {
            // fallback
            return $('<div>').addClass('edge_builder');
    ...
    edges.top.addClass(('edge_builder_top'));
    edges.right.addClass(('edge_builder_right'));
    edges.bottom.addClass(('edge_builder_bottom'));
    edges.left.addClass(('edge_builder_left'));
    ...
    this.highlight = function(el) {
        //console.log("HIGHLIGHTING ........ " + el.id + " - " + el.tagName);
        if (!el) {
            self.hide(); return;
        }
        if (el.nodeType != 1)
