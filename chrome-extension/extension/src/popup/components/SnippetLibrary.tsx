...
export function SnippetLibrary({ snippets, onOpen, onDelete, onCopy, isGuest, onCopyPromptAsGuest, isFree, onCopyPromptAsFree, showSyncStatus, onRetrySync }: SnippetLibraryProps): React.ReactElement {
  return (
